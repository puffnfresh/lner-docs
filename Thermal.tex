...
Before the traction system is approved for regular service, a structured commissioning process will be undertaken to validate safe operation under realistic operating conditions. The commissioning process consists of multiple supervised trial runs with periodic checks to verify that the system remains within safe thermal and electrical limits.
...
Following successful commissioning, an initial post-service review will occur after 25~operating hours or one month of regular service, whichever comes first. The inspection will focus on connection integrity, signs of thermal stress such as discolouration, and any evidence of corrosion or moisture ingress. The same manual temperature checks and BMS status verification used during commissioning should be repeated. Annual inspections will be conducted thereafter as part of the routine maintenance cycle of the vehicle.
